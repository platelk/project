...
** Last update Sat May 26 14:24:03 2012 alexis leprovost
*/
...
int
modif_position(double *position, t_object *object, double *location, int flag)
{
...
int
modif_vector(double *rotation, double *old_vector, double *new_vector, int flag)
{
