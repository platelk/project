...
class   rayTracer:
    ...
    def run(self, link):
        ...
        if (self.client):
            ...
            if (self.c_thread):
                s += "-t " + self.c_thread
        commands.getstatusoutput(str(s))
...
###########
    def MainResize(self):
        ...
        self.toolBar.setGeometry(0, size_menubar, 200, self.menu_start - size_menubar)
...
###########
    ...
    def runRayTracer(self):
        if (self.Name):
            ...
            print "Le nom = " + name
            print self.Name + "/" + name + "-" + str(i) + ".jpg"
            try:
                fd = open(self.Name + "/" + name + "-" + str(i) + ".jpg")
                while (fd > 0):
                    self.allImg.addImage(self.Name + "/" + name + "-" + str(i) + ".jpg")
                    i += 1
                    fd.close
                    fd = open(self.Name + "/" + name + "-" + str(i) + ".jpg")
            except:
