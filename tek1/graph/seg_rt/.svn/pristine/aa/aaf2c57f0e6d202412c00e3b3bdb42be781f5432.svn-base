/*
** obj_create_list_cam.c for obj in /home/vink/projet/graph/rt
**
** Made by kevin platel
** Login   <vink@epitech.net>
**
** Started on  Tue May  8 20:24:19 2012 kevin platel
** Last update Tue May  8 20:44:00 2012 kevin platel
*/
...
t_camera	*obj_create_cam(t_xtree *tree, t_camera *cam)
{
  ...
  tmp = xml_find_in_tree(tree, "camera/fov");
  if (!tmp)
    new->fov = 0.0;
  else
...
t_camera	*obj_create_list_cam(t_xtree *tree)
{
  ...
  tree = xml_find_in_tree(tree, "window/scene/cameras/camera");
  if (!tree)
    return (NULL);
  cam = NULL;
  tmp = cam;
