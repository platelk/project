...
** Last update Thu May 24 17:46:37 2012 ronan guiho
*/
...
void	init_b_tore(t_object *o)
{
  ...
  i = -1;
  while (++i < 3)
    o->box_pos[i] = o->position[i] - (((t_tore *)o->son)->radius[1] + ((t_tore *)o->son)->radius[0]);
  i = -1;
  while (++i < 3)
    o->box_size[i] = 2 * (((t_tore *)o->son)->radius[1] + ((t_tore *)o->son)->radius[0]);
}
