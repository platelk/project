...
** Last update Tue May 29 19:53:44 2012 zoe phalippou
*/
...
int     mlx_mouse_hook (void *, int (*funct_ptr)(), void *);
int     mlx_key_hook (void *, int (*funct_ptr)(), void *);
int     mlx_expose_hook (void *, int (*funct_ptr)(), void *);
int     mlx_loop (void *);
