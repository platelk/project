...
class effect:
    ...
    def getText(self):
        r = "<effect BRIGHTNESS=\"" + str(float(self.Brightness.sliderPosition()) / 100.0) + "\" REFLECTION=\"" + str(float(self.Reflection.sliderPosition()) / 100.0) + "\" " + "PHONG=\"" + str(float(self.Phong.sliderPosition())) + "\" TRANSPARENCY=\""+ str(float(self.Transparency.sliderPosition()) / 100.0) + "\" />"
        return (r)
