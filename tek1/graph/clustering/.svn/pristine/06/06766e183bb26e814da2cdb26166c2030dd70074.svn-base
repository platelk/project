...
** Last update Sat May  5 22:37:32 2012 ronan guiho
*/
...
int		server_distribution_plage_calcul_add(t_plage **list, \
...
t_plage		*server_distribution_plage_calcul()
{
  ...
  atribution_client[0] = WIDTH / count_client;
  atribution_client[1] = WIDTH % count_client;
  while ((i + atribution_client[1]) < WIDTH)
    {
      if ((server_distribution_plage_calcul_add(&list, i, i + atribution_client[0], \
						HEIGHT)) == EXIT_FAILURE)
	return (NULL);
